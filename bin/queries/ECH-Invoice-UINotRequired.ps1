...
# Set the connection type to allow access even if QuickBooks is not running
$connectionType = 1 # localQBD

# Open connection to QuickBooks
$qbxmlrp.OpenConnection2("", "ECHQuickBooksAutomationScript", $connectionType)

# Set the authorization preferences to allow unattended access
$authPrefs = $qbxmlrp.AuthPreferences
$authPrefs.PutUnattendedModePref(2) # umptRequired
