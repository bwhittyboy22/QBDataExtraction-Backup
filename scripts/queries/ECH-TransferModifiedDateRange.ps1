...
<?qbxml version="13.0"?>
  <QBXML>
    <QBXMLMsgsRq onError="continueOnError">
      <TransferQueryRq requestID="2">
        <ModifiedDateRangeFilter>
          <FromModifiedDate>2024-08-01</FromModifiedDate>
          <ToModifiedDate>2024-08-31</ToModifiedDate>
        </ModifiedDateRangeFilter>
      </TransferQueryRq>
    </QBXMLMsgsRq>
  </QBXML>
...
try {
    ...
    $filePath = Join-Path -Path $subfolderPath -ChildPath "${currentDateTime_FileName}_ECH_TransferModifiedDateRange.xml"
